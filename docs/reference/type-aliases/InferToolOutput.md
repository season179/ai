...
Defined in: [packages/ai/src/activities/chat/tools/tool-definition.ts:84](https://github.com/TanStack/ai/blob/main/packages/ai/src/activities/chat/tools/tool-definition.ts#L84)
