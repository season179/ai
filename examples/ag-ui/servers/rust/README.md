# Rust AG-UI chat server

AG-UI SSE server using Axum. Streams simple chat completions from OpenAI or Anthropic.
...
pnpm dev:rust
# or
cargo run --manifest-path servers/rust/Cargo.toml
```
